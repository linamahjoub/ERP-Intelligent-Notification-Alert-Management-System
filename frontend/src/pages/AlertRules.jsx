...
const AlertRules = () => {
  ...
  const fetchAlerts = () => {
    try {
      ...
      // Récupérer les alertes depuis localStorage
      const storedAlerts = localStorage.getItem('alerts');
      const alertsData = storedAlerts ? JSON.parse(storedAlerts) : [];
      
      console.log('Alertes chargées:', alertsData);
  ...
  console.log('AlertRules - User:', user);
  console.log('AlertRules - is_superuser:', user?.is_superuser);
  console.log('AlertRules - is_staff:', user?.is_staff);
      ...
      <Box component="main" sx={{ flexGrow: 1, width: "100%", minHeight: "100vh", bgcolor: "black", overflowY: "auto" }}>
        ...
        <Box sx={{ p: 1.2, borderBottom: "1px solid rgba(59, 130, 246, 0.1)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 2 }}>
          ...
          <Box sx={{ flex: 1, maxWidth: 500, position: "relative" }}>
            ...
            <input
              type="text"
              placeholder="Rechercher une alerte par nom, module, description..."
              value={searchTerm}
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
              ...
              <Avatar sx={{ width: 40, height: 40, bgcolor: "#ef4444" }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3, flexWrap: "wrap", gap: 2 }}>
            <Box>
              ...
              <Typography variant="body2" sx={{ color: "#64748b", fontSize: "0.95rem" }}>
                Configurez et gérez vos règles de notification personnalisées
              </Typography>
            </Box>
            ...
            {filteredAlerts.length > 0 ? (
                        ...
                        <TableCell>
                          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            ...
                            <Typography variant="body2" sx={{ color: "#94a3b8" }}>
                              {modules.find(m => m.value === alert.module)?.label || alert.module}
                            </Typography>
                          </Box>
                        </TableCell>
                        <TableCell>
                          ...
                          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                            ...
                            {alert.conditions?.length > 2 && (
                              <Typography variant="caption" sx={{ color: '#3b82f6', fontSize: '0.7rem', fontWeight: 600 }}>
                                +{alert.conditions.length - 2} autre{alert.conditions.length - 2 > 1 ? 's' : ''}
                              </Typography>
                            )}
                          </Box>
                        </TableCell>
              ...
              <CardContent sx={{ textAlign: "center", py: 8 }}>
                ...
                <Typography sx={{ color: "#64748b", mb: 3, maxWidth: 400, mx: "auto" }}>
                  Commencez par créer votre première règle d'alerte pour surveiller vos données ERP.
                </Typography>
                <Button
                  variant="contained"
                  startIcon={<AddIcon />}
...
// Liste des modules pour l'affichage des libellés
const modules = [
