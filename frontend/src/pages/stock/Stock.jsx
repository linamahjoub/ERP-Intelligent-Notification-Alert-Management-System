...
const DashboardStock = () => {
  ...
  const statCards = [
    { label: "Total Produits", value: stats.totalProducts, accent: "#3b82f6", onClick: () => { setFilterStatus("all"); setFilterCategory("all"); } },
    { label: "Stock Optimal", value: stats.optimalStock, accent: "#10b981", onClick: () => { setFilterStatus("optimal"); setFilterCategory("all"); } },
    { label: "Stock Bas", value: stats.lowStockProducts, accent: "#f59e0b", onClick: () => { setFilterStatus("low"); setFilterCategory("all"); } },
    { label: "Rupture", value: stats.outOfStockProducts, accent: "#ef4444", onClick: () => { setFilterStatus("out_of_stock"); setFilterCategory("all"); } },
